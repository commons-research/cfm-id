...
class InvalidConfigException : public std::exception {
	...
	virtual const char *what() const noexcept { return "Invalid Feature Configuration File"; }
};
...
public:
	explicit FeatureCalculationException(const std::string &message) noexcept : message_(message) {};
