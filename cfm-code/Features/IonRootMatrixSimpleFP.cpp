...
void IonRootGeneralizedMatrixFPN8::compute(FeatureVector &fv, const std::unique_ptr<RootedROMol> &ion,
...
void IonRootGeneralizedMatrixFPN10::compute(FeatureVector &fv, const std::unique_ptr<RootedROMol> &ion,
                                            const std::unique_ptr<RootedROMol> &nl) const {
...
void IonRootMatrixSimpleFPN8D3::compute(FeatureVector &fv, const std::unique_ptr<RootedROMol> &ion,
                                        const std::unique_ptr<RootedROMol> &nl) const {
...
void IonRootMatrixSimpleFPN10::compute(FeatureVector &fv, const std::unique_ptr<RootedROMol> &ion,
                                       const std::unique_ptr<RootedROMol> &nl) const {
...
void IonRootMatrixSimpleFPN16::compute(FeatureVector &fv, const std::unique_ptr<RootedROMol> &ion,
                                       const std::unique_ptr<RootedROMol> &nl) const {
...
void IonRootMatrixSimpleFPN32::compute(FeatureVector &fv, const std::unique_ptr<RootedROMol> &ion,
                                       const std::unique_ptr<RootedROMol> &nl) const {
