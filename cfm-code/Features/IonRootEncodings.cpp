...
void IonRootEncodingD3::compute(FeatureVector &fv, const std::unique_ptr<RootedROMol> &ion,
...
void IonRootEncodingN10::compute(FeatureVector &fv, const std::unique_ptr<RootedROMol> &ion,
                                 const std::unique_ptr<RootedROMol> &nl) const {
...
void IonRootEncodingD4::compute(FeatureVector &fv, const std::unique_ptr<RootedROMol> &ion,
                                const std::unique_ptr<RootedROMol> &nl) const {
...
void IonRootEncodingMorganD3::compute(FeatureVector &fv, const std::unique_ptr<RootedROMol> &ion,
                                      const std::unique_ptr<RootedROMol> &nl) const {
