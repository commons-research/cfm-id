...
void NLRootEncodingD3::compute(FeatureVector &fv, const std::unique_ptr<RootedROMol> &ion,
...
void NLRootEncodingN10::compute(FeatureVector &fv, const std::unique_ptr<RootedROMol> &ion,
                                const std::unique_ptr<RootedROMol> &nl) const {
	int ring_break;
	nl->mol.get()->getProp("IsRingBreak", ring_break);
...
void NLRootEncodingMorganD3::compute(FeatureVector &fv, const std::unique_ptr<RootedROMol> &ion,
                                     const std::unique_ptr<RootedROMol> &nl) const {
	int ring_break;
	nl->mol.get()->getProp("IsRingBreak", ring_break);
...
void NLRootEncodingD4::compute(FeatureVector &fv, const std::unique_ptr<RootedROMol> &ion,
                               const std::unique_ptr<RootedROMol> &nl) const {
	int ring_break;
	nl->mol.get()->getProp("IsRingBreak", ring_break);
