...
void NLRootGeneralizedMatrixFPN8::compute(FeatureVector &fv, const std::unique_ptr<RootedROMol> &ion,
...
void NLRootGeneralizedMatrixFPN10::compute(FeatureVector &fv, const std::unique_ptr<RootedROMol> &ion,
                                           const std::unique_ptr<RootedROMol> &nl) const {
...
void NLRootMatrixSimpleFPN8D3::compute(FeatureVector &fv, const std::unique_ptr<RootedROMol> &ion,
                                       const std::unique_ptr<RootedROMol> &nl) const {
	unsigned int num_atoms        = 8;
...
void NLRootMatrixSimpleFPN10::compute(FeatureVector &fv, const std::unique_ptr<RootedROMol> &ion,
                                      const std::unique_ptr<RootedROMol> &nl) const {
	unsigned int num_atoms        = 10;
	bool include_adjacency_matrix = false;
	bool use_full_symbol_set      = false;
...
void NLRootMatrixSimpleFPN16::compute(FeatureVector &fv, const std::unique_ptr<RootedROMol> &ion,
                                      const std::unique_ptr<RootedROMol> &nl) const {
...
void NLRootMatrixSimpleFPN32::compute(FeatureVector &fv, const std::unique_ptr<RootedROMol> &ion,
                                      const std::unique_ptr<RootedROMol> &nl) const {
