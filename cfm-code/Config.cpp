...
void initConfig(config_t &cfg, std::string &filename, char *argv_zero, bool report_all) {
	...
	while (ifs.good()) {
		...
		if (name == "lambda")
			cfg.lambda = value;
		else if (name == "ionization_mode")
			cfg.ionization_mode = (int)value;
		// else if (name == "converge_count_thresh") cfg.converge_count_thresh = (int) value;
		else if (name == "em_converge_thresh")
			cfg.em_converge_thresh = value;
		else if (name == "ga_converge_thresh")
			cfg.ga_converge_thresh = value;
		else if (name == "update_bias_first")
			cfg.update_bias_first = (int)value;
		else if (name == "model_depth")
			cfg.model_depth = (unsigned int)value;
		else if (name == "spectrum_depth")
			cfg.spectrum_depths.push_back((unsigned int)value);
		else if (name == "spectrum_weight")
			cfg.spectrum_weights.push_back((double)value);
		else if (name == "abs_mass_tol")
			cfg.abs_mass_tol = (double)value;
		else if (name == "ppm_mass_tol")
			cfg.ppm_mass_tol = (double)value;
		else if (name == "num_em_restarts")
			cfg.num_em_restarts = (int)value;
		else if (name == "starting_step_size")
			cfg.starting_step_size = (float)value;
		else if (name == "ending_step_size")
			cfg.ending_step_size = (float)value;
		else if (name == "decay_rate")
			cfg.decay_rate = (double)value;
		else if (name == "fg_depth")
			cfg.fg_depth = (int)value;
		else if (name == "allow_frag_detours")
			cfg.allow_frag_detours = (int)value;
		else if (name == "max_ring_breaks")
			cfg.max_ring_breaks = (int)value;
		else if (name == "include_isotopes")
			cfg.include_isotopes = (int)value;
		else if (name == "isotope_thresh")
			cfg.isotope_thresh = (double)value;
		else if (name == "ga_method")
			cfg.ga_method = (int)value;
		else if (name == "param_init_type")
			cfg.param_init_type = (int)value;
		else if (name == "use_lower_energy_params_for_init")
			cfg.use_lower_energy_params_for_init = (int)value;
		else if (name == "theta_function")
			cfg.theta_function = (int)value;
		else if (name == "theta_nn_hlayer_num_nodes")
			cfg.theta_nn_hlayer_num_nodes.push_back((int)value);
		else if (name == "theta_nn_layer_act_func_ids")
			cfg.theta_nn_layer_act_func_ids.push_back((int)value);
		else if (name == "nn_layer_dropout_probs")
			cfg.nn_layer_dropout_probs.push_back((float)value);
		else if (name == "nn_layer_freeze")
			cfg.nn_layer_is_frozen_flags.push_back((bool)value);
		else if (name == "ga_minibatch_nth_size")
			cfg.ga_minibatch_nth_size = (int)value;
		else if (name == "ga_max_iterations")
			cfg.ga_max_iterations = (int)value;
		else if (name == "ga_momentum")
			cfg.ga_momentum = (double)value;
		else if (name == "ga_adam_beta_1")
			cfg.ga_adam_beta_1 = (double)value;
		else if (name == "ga_adam_beta_2")
			cfg.ga_adam_beta_2 = (double)value;
		else if (name == "ga_adam_eps")
			cfg.ga_adam_eps = (double)value;
		else if (name == "ga_adamw_w")
			cfg.ga_adamw_w = (double)value;
		else if (name == "ga_adam_ga_adam_use_amsgrad")
			cfg.ga_adam_use_amsgrad = (bool)value;
		else if (name == "ga_adadelta_rho")
			cfg.ga_adadelta_rho = (double)value;
		else if (name == "ga_decay_method")
			cfg.ga_decay_method = (int)value;
		else if (name == "exp_decay_k")
			cfg.exp_decay_k = (double)value;
		else if (name == "step_decay_drop")
			cfg.step_decay_drop = (double)value;
		else if (name == "step_decay_epochs_drop")
			cfg.step_decay_epochs_drop = (double)value;
		else if (name == "obs_function")
			cfg.obs_function = (int)value;
		else if (name == "include_h_losses")
			cfg.include_h_losses = (int)value;
		else if (name == "include_precursor_h_losses_only")
			cfg.include_precursor_h_losses_only = (int)value;
		else if (name == "fragraph_compute_timeout_in_secs")
			cfg.fragraph_compute_timeout_in_secs = (int)value;
		else if (name == "ga_use_best_q")
			cfg.ga_use_best_q = (int)value;
		else if (name == "ga_sampling_method")
			cfg.ga_sampling_method = (int)value;
		else if (name == "ga_sampling_method2")
			cfg.ga_sampling_method2 = (int)value;
		else if (name == "ga_reset_sampling")
			cfg.ga_reset_sampling = (bool)value;
		else if (name == "ga_sampling_max_selection")
			cfg.ga_sampling_max_selection = (int)value;
		else if (name == "ga_diff_sampling_peak_num")
			cfg.ga_diff_sampling_peak_num = (int)value;
		else if (name == "ga_diff_sampling_difference")
			cfg.ga_diff_sampling_difference = (double)value;
		else if (name == "disable_cross_val_metrics")
			cfg.disable_cross_val_metrics = (int)value;
		else if (name == "disable_training_metrics")
			cfg.disable_training_metrics = (int)value;
		else if (name == "disable_cpu_usage_metrics")
			cfg.disable_cpu_usage_metrics = (bool)value;
		else if (name == "em_no_progress_count")
			cfg.em_no_progress_count = (int)value;
		else if (name == "ga_no_progress_count")
			cfg.ga_no_progress_count = (int)value;
		else if (name == "collected_all_used_idx")
			cfg.collected_all_used_idx = (bool)value;
		else if (name == "em_max_iterations")
			cfg.em_max_iterations = (int)value;
		else if (name == "allow_intermediate_peak")
			cfg.allow_intermediate_peak = (bool)value;
		else if (name == "allow_cyclization")
			cfg.allow_cyclization = (bool)value;
		else if (name == "use_log_scale_peak")
			cfg.use_log_scale_peak = (bool)value;
		else if (name == "use_iterative_fg_gen")
			cfg.use_iterative_fg_gen = (bool)value;
		else if (name == "default_predicted_peak_min")
			cfg.default_predicted_peak_min = (int)value;
		else if (name == "default_predicted_peak_max")
			cfg.default_predicted_peak_max = (int)value;
		else if (name == "default_predicted_min_intensity")
			cfg.default_predicted_min_intensity = (double)value;
		else if (name == "default_postprocessing_energy")
			cfg.default_postprocessing_energy = (double)value;
		else if (name == "default_mz_decimal_place")
			cfg.default_mz_decimal_place = (int)value;
		else if (name == "intensity_msg_weight")
			cfg.intensity_msg_weight = (double)value;
		else
			std::cout << "Warning: Unknown parameter configuration identifier " << name << std::endl;
	}
	ifs.close();
	...
	if (cfg.theta_function == NEURAL_NET_THETA_FUNCTION) {
		if (cfg.theta_nn_layer_act_func_ids.size() < cfg.theta_nn_hlayer_num_nodes.size() + 1) {
			std::cout << "Warning: Activations function types not specified for all neural net layers, using default "
			             "activations for unspecified layers."
			          << std::endl;
	...
	if (cfg.ending_step_size < 0) cfg.ending_step_size = cfg.starting_step_size * 0.25f;
	...
	if (report_all) {
		...
		if (cfg.include_isotopes) {
			...
			std::cout << "Not including fragment isotopes" << std::endl;
		...
		if (cfg.allow_intermediate_peak) std::cout << "Allowing intermediate peaks" << std::endl;
		if (cfg.allow_cyclization) std::cout << "Allowing cyclization" << std::endl;
		if (cfg.use_log_scale_peak) std::cout << "Using log scale peak" << std::endl;
		if (cfg.use_iterative_fg_gen) std::cout << "Using iterative fragmentation graph generation" << std::endl;
		...
		if (cfg.param_init_type == PARAM_RANDOM_INIT)
			std::cout << "Using Random Parameter Initialisation" << std::endl;
		else if (cfg.param_init_type == PARAM_FULL_ZERO_INIT)
			std::cout << "Using Full Zero Initialisation" << std::endl;
		else if (cfg.param_init_type == PARAM_ZERO_INIT)
			std::cout << "Using Zero Initialisation (non-zero Bias)" << std::endl;
		else if (cfg.param_init_type == PARAM_NORMAL_INIT)
			std::cout << "Using NORMAL Initialisation FOR NN" << std::endl;
		else
		...
		if (USE_MOMENTUM_FOR_GA == cfg.ga_method) {
			...
			std::cout << "Using Starting Step Size " << cfg.starting_step_size << " momentum " << cfg.ga_momentum
			          << " decay rate " << cfg.decay_rate << " Ending Step Size " << cfg.ending_step_size << std::endl;
			...
			std::cout << "Using Starting Step Size " << cfg.starting_step_size << " decay rate " << cfg.decay_rate
			          << " eps " << cfg.ga_adam_eps << " Ending Step Size " << cfg.ending_step_size << std::endl;
		} else if (USE_ADAM_FOR_GA == cfg.ga_method || USE_ADABELIEF_FOR_GA == cfg.ga_method ||
			...
			std::cout << "Using starting step size " << cfg.starting_step_size << " ending step size "
			          << cfg.ending_step_size << " beta1  " << cfg.ga_adam_beta_1 << " beta2 " << cfg.ga_adam_beta_2
			          << " eps " << cfg.ga_adam_eps << " amsgrad " << cfg.ga_adam_use_amsgrad;
			if (USE_ADAMW_FOR_GA == cfg.ga_method) std::cout << " ga_adamw_w " << cfg.ga_adamw_w;
			std::cout << std::endl;
		}
		...
		case USE_EXP_DECAY:
			...
			break;
		case USE_STEP_DECAY:
			std::cout << "Using Step Decay Learning Rate Method. drop: " << cfg.step_decay_drop
			          << " epochs drop: " << cfg.step_decay_epochs_drop << std::endl;
			break;
		case USE_NO_DECAY:
		default: std::cout << "NOT Using Decay Method" << std::endl;
		}
		if (cfg.ga_use_best_q) std::cout << "Using Best Q instead of Prev Q in GA" << std::endl;
		...
		if (cfg.theta_function == LINEAR_THETA_FUNCTION)
			std::cout << "Using linear function for theta" << std::endl;
			...
			for (int theta_nn_hlayer_num_node : cfg.theta_nn_hlayer_num_nodes)
				std::cout << std::setw(10) << theta_nn_hlayer_num_node;
			std::cout << std::endl;
			...
			for (int i = 0; i < cfg.theta_nn_layer_act_func_ids.size(); i++) {
				...
				case RELU_NN_ACTIVATION_FUNCTION: std::cout << std::setw(10) << "Relu"; break;
				case LEAKY_RELU_NN_ACTIVATION_FUNCTION: std::cout << std::setw(10) << "Leaky Relu"; break;
				...
				default: std::cout << std::setw(10) << "Linear";
				}
			}
			std::cout << std::endl;

			std::cout << "Hidden layer dropout: ";
			for (float nn_layer_dropout_prob : cfg.nn_layer_dropout_probs)
				std::cout << std::setw(10) << nn_layer_dropout_prob;
			std::cout << std::endl;

			std::cout << "Hidden layer freeze:  ";
			for (bool nn_layer_is_frozen_flag : cfg.nn_layer_is_frozen_flags)
				std::cout << std::setw(10) << nn_layer_is_frozen_flag;
			std::cout << std::endl;
		}
		...
		if (cfg.fragraph_compute_timeout_in_secs > 0)
			std::cout << "Timeout set on fragment graph computation to " << cfg.fragraph_compute_timeout_in_secs
			          << " seconds" << std::endl;
		if (cfg.use_log_scale_peak) std::cout << "Use log scale peaks" << std::endl;
	}
}
...
void printSamplingConfig(const int &sampling_method, config_t &cfg) {
	...
	case USE_RANDOM_SAMPLING:
		std::cout << "Random Sampling on transitions  with max selection cut off at " << cfg.ga_sampling_max_selection
		          << std::endl;
		break;
	case USE_GRAPH_RANDOM_WALK_SAMPLING:
		std::cout << "Graph Random Walk Sampling with " << cfg.ga_sampling_max_selection << " iterations" << std::endl;
		break;
	...
	case USE_DIFFERENCE_SAMPLING_BFS:
		std::cout << "Difference sampling BFS with max selected peak count at " << cfg.ga_diff_sampling_peak_num
		          << std::endl;
		break;
	case USE_NO_SAMPLING:
	default: std::cout << "NO Sampling Method" << std::endl;
	}
}
...
void initDerivedConfig(config_t &cfg, int se_energy) {
	...
	for (unsigned int d = 0; d < cfg.model_depth; d++) {
		auto it = cfg.spectrum_depths.begin();
	...
	cfg.dv_spectrum_indexes.clear();
	if (se_energy >= 0)
		cfg.dv_spectrum_indexes.push_back(se_energy);
	else {
		for (int i = 0; i < cfg.dv_spectrum_depths.size(); i++) cfg.dv_spectrum_indexes.push_back(i);
	}
}
