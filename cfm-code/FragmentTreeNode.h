...
public:
	...
	FragmentTreeNode(romol_ptr_t an_ion, romol_ptr_t a_nl, int a_ion_free_ep, int a_depth, FeatureHelper *a_fh,
	    ...
	    : ion(an_ion), nl(a_nl), ion_free_epairs(a_ion_free_ep), depth(a_depth), fh(a_fh), e_loc(a_e_loc),
	...
	FragmentTreeNode(romol_ptr_t an_ion, int a_ion_free_ep, int a_depth, FeatureHelper *a_fh, std::vector<int> &a_e_loc)
	    : ion(an_ion), ion_free_epairs(a_ion_free_ep), depth(a_depth), fh(a_fh), e_loc(a_e_loc),
