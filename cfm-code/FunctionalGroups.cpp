...
const std::string FGRPS_PICKLE =
    ...
    "fr_benzene	c1ccccc1\n"
    "fr_phos_acid	"
    "[$(P(=[OX1])([$([OX2H]),$([OX1-]),$([OX2]P)])([$([OX2H]),$([OX1-]),$([OX2]P)])[$([OX2H]),$([OX1-]),$([OX2]P)]),$(["
    "P+]([OX1-])([$([OX2H]),$([OX1-]),$([OX2]P)])([$([OX2H]),$([OX1-]),$([OX2]P)])[$([OX2H]),$([OX1-]),$([OX2]P)])]\n"
    "fr_phos_ester	"
    "[$(P(=[OX1])([OX2][#6])([$([OX2H]),$([OX1-]),$([OX2][#6])])[$([OX2H]),$([OX1-]),$([OX2][#6]),$([OX2]P)]),$([P+](["
    "OX1-])([OX2][#6])([$([OX2H]),$([OX1-]),$([OX2][#6])])[$([OX2H]),$([OX1-]),$([OX2][#6]),$([OX2]P)])]\n"
    ...
    "[$([cH]1[cH]cc(c[cH]1)~[$([#8,$([#8]~[H,c,C])])]),$([cH]1[cH]cc(c[cH]1)~[$([#7X3,$([#7](~[H,c,C])~[H,c,C])])]),$(["
    "cH]1[cH]cc(c[cH]1)-!:[$([NX3H,$(NC(=O)[H,c,C])])])]\n"
    ...
    "y_46	"
    "[#7;X3;$([H2]),$([H1][#6;!$(C=[O,N,S])]),$([#7]([#6;!$(C=[O,N,S])])[#6;!$(C=[O,N,S])])][$([CX3;!R][#6]),$([CX3H;!"
    "R])]=[S;X1]\n"
    ...
    "y_87	"
    "[#7;X3;$([H2]),$([H1][#6;!$(C=[O,N,S])]),$([#7]([#6;!$(C=[O,N,S])])[#6;!$(C=[O,N,S])])][#16;A;X4;$([H1]),$([H0][#"
    "6])](=[O;X1])=[O;X1]\n"
    "y_88	"
    "[#6;R1]-,=1-,=[#6;R1]-,=[#6]-,=2-,=[#6;R1]-,=[#6;R1]-,=[#6]-3-,=[#6]-,=4-,=[#6;R1]-,=[#6;R1]-,=[#6;R1]-,=[#6;R1]-,"
    "=[#6]-,=4-,=[#6;R1]-,=[#6;R1]-,=[#6]-3-,=[#6]-,=2-,=[#6;R1]-,=1\n"
    "y_89	N1CCNC1\n"
...
const std::string EXTRA_FGRPS_PICKLE = "0 20 1e-008\n"
                                       "13\n"
                                       "x_CH0	[CH0]\n"
                                       "x_CH1	[CH1]\n"
                                       "x_CH2	[CH2]\n"
...
const std::string PI_BOND_FGRPS_PICKLE = "0 20 1e-008\n"
                                         "1\n"
                                         "NitroGroup	[N+](=O)[O-]\n";
//"azide_ion	[$([#7-]=[N+]=[#7-])]\n";
